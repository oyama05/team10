  ...
  function AddDateTime(){
      ...
      if(calendar.Options.NavShow && !calendar.Options.NavVertical){
        ...
        rwd.addEventListener('click', function(){
          createCalendar(calendar, element, -1);
          var yotei = document.getElementById('daily_yotei');
          createDailyYotei(calendar, yotei, -1);
        } );
        rwd.innerHTML = '<svg height="25" width="25" viewBox="0 0 75 100" fill="rgba(0,0,0,0.5)"><polyline points="0,50 75,0 75,100"></polyline></svg>';
      ...
      if(calendar.Options.NavShow && !calendar.Options.NavVertical){
        ...
        fwd.innerHTML = '<svg height="25" width="25" viewBox="0 0 75 100" fill="rgba(0,0,0,0.5)"><polyline points="0,0 75,50 0,100"></polyline></svg>';
    ...
    for(var i = 0; i < calendar.Selected.Days; i++){
      ...
      for(var n = 0; n < calendar.Model.length; n++){
        ...
        if(evDate.getTime() == toDate.getTime()){
          ...
          number.innerHTML += "<font size='-2'>" + category[calendar.Model[n].Category] + "</font>";
